...
export var typeColors = {beratung:'bg-blue-100 text-blue-700 border-blue-300',serviceannahme:'bg-amber-100 text-amber-700 border-amber-300',abholung:'bg-emerald-100 text-emerald-700 border-emerald-300',ergonomieberatung:'bg-purple-100 text-purple-700 border-purple-300',ergocheck:'bg-violet-100 text-violet-700 border-violet-300',fahrspasscheck:'bg-green-100 text-green-700 border-green-300',sonstig:'bg-gray-200 text-gray-600 border-gray-300',meeting:'bg-indigo-100 text-indigo-700 border-indigo-300',schulung:'bg-cyan-100 text-cyan-700 border-cyan-300',event:'bg-pink-100 text-pink-700 border-pink-300',deadline:'bg-red-100 text-red-700 border-red-300'};
export var typeLabels = {beratung:'Beratung',serviceannahme:'Serviceannahme',abholung:'Abholung',ergonomieberatung:'Ergonomieberatung',ergocheck:'Ergo-Check',fahrspasscheck:'Fahrspaßcheck',sonstig:'Sonstiges',meeting:'Meeting',schulung:'Schulung',event:'Event',deadline:'Deadline'};
var typeSolid = {beratung:'bg-blue-500',serviceannahme:'bg-amber-500',abholung:'bg-emerald-500',ergonomieberatung:'bg-purple-500',ergocheck:'bg-violet-500',fahrspasscheck:'bg-green-500',sonstig:'bg-gray-500',meeting:'bg-indigo-500',schulung:'bg-cyan-500',event:'bg-pink-500',deadline:'bg-red-500'};
