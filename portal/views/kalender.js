...
export var typeColors = {beratung:'bg-blue-100 text-blue-700 border-blue-300',probefahrt:'bg-green-100 text-green-700 border-green-300',werkstatt:'bg-gray-200 text-gray-700 border-gray-300',meeting:'bg-purple-100 text-purple-700 border-purple-300',sonstig:'bg-orange-100 text-orange-700 border-orange-300',schulung:'bg-indigo-100 text-indigo-700 border-indigo-300',event:'bg-pink-100 text-pink-700 border-pink-300',deadline:'bg-red-100 text-red-700 border-red-300',inspektion:'bg-cyan-100 text-cyan-700 border-cyan-300',reparatur:'bg-amber-100 text-amber-700 border-amber-300',abholung:'bg-emerald-100 text-emerald-700 border-emerald-300',abgabe:'bg-teal-100 text-teal-700 border-teal-300',online_beratung:'bg-violet-100 text-violet-700 border-violet-300',etermin:'bg-yellow-100 text-yellow-700 border-yellow-300'};
export var typeLabels = {beratung:'Beratung',probefahrt:'Probefahrt',werkstatt:'Werkstatt',meeting:'Meeting',sonstig:'Sonstiges',schulung:'Schulung',event:'Event',deadline:'Deadline',inspektion:'Inspektion',reparatur:'Reparatur',abholung:'Abholung',abgabe:'Abgabe',online_beratung:'Online-Beratung',etermin:'eTermin'};
var typeSolid = {beratung:'bg-blue-500',probefahrt:'bg-green-500',werkstatt:'bg-gray-500',meeting:'bg-purple-500',sonstig:'bg-orange-500',schulung:'bg-indigo-500',event:'bg-pink-500',deadline:'bg-red-500',inspektion:'bg-cyan-500',reparatur:'bg-amber-500',abholung:'bg-emerald-500',abgabe:'bg-teal-500',online_beratung:'bg-violet-500',etermin:'bg-yellow-500'};
