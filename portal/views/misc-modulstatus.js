...
var MODUL_DATEN = {
    ...
    hq: [
        ...
        {name:'Spiritus', view:'spiritusView', status:'teilweise', typ:'hq', version:'3.0.0', details:'8-Felder-Protokoll, KI-Transkription, 3 Kontexte (Partner/Lieferant/Akquise), Lernfaktor, Todo-Flow', kiPrio:5, aufwand:'L', kiTodo:'AssemblyAI-Umbau, 3CX-Webhook-Ingest, Teams-Integration, Realtime Call-Trigger'}
    ],
    widgets: [
