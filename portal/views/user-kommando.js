...
export async function openStandortDetail(standortId) {
    // Delegiert an standort-billing.js Modal
    if (typeof openStandortDetailModal === 'function') {
        openStandortDetailModal(standortId);
    }
}

const _exports = { showKommandoTab, filterKzStandorte, filterKzMa, renderKzStandorte, renderKzMitarbeiter, openBetaUsersModal, openStandortDetail, filterBetaUserList, addBetaUser, removeBetaUser };
