...
window.openAnkuendigungModal = openAnkuendigungModal;
window.closeAnkModal = closeAnkModal;
window.saveAnkuendigung = saveAnkuendigung;
window.renderHqKomm = renderHqKomm;
window.renderHqKampagnen = renderHqKampagnen;
window.addHqKampagne = addHqKampagne;
window.filterHqDok = filterHqDok;
window.loadNetzwerkDokumente = loadNetzwerkDokumente;
window.renderHqDokumente = renderHqDokumente;
window.formatFileSize = formatFileSize;
window.downloadDokument = downloadDokument;
window.deleteNetzwerkDok = deleteNetzwerkDok;
window.loadHqKalTermine = loadHqKalTermine;
window.filterHqKal = filterHqKal;
window.renderHqKalender = renderHqKalender;
window.addHqKalTermin = addHqKalTermin;
window.filterHqTasks = filterHqTasks;
window.renderHqAufgaben = renderHqAufgaben;
window.addHqTask = addHqTask;
window.calculateBwaAge = calculateBwaAge;
window.countFeaturesUsed = countFeaturesUsed;
window.calculateActivityScore = calculateActivityScore;
window.loadPortalNutzungData = loadPortalNutzungData;
...
window.renderHqIdeen = renderHqIdeen;
window.filterHqIdeen = filterHqIdeen;
window.renderKiAnalyseHtml = renderKiAnalyseHtml;
window.toggleKiPanel = toggleKiPanel;
window.analysiereIdee = analysiereIdee;
window.analysierAlleNeuen = analysierAlleNeuen;
window.updateIdeeStatus = updateIdeeStatus;
