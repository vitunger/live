...
export function openHQPerfAbfrageModal() {
  ...
  h += '<div><label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:4px">Titel der Abfrage</label><input style="width:100%;border:1px solid #e5e7eb;border-radius:8px;padding:8px 12px;font-size:13px;outline:none;box-sizing:border-box" id="hqPerfTitel" value="Performance-Abfrage Geschäftsjahr 2024/25" placeholder="z.B. Performance-Abfrage GJ 2024/25"></div>';
  h += '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px"><div><label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:4px">Zeitraum aktuell</label><input style="width:100%;border:1px solid #e5e7eb;border-radius:8px;padding:8px 12px;font-size:13px;box-sizing:border-box" id="hqPerfAkt" value="09/2024 – 08/2025"></div><div><label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:4px">Zeitraum Vorjahr</label><input style="width:100%;border:1px solid #e5e7eb;border-radius:8px;padding:8px 12px;font-size:13px;box-sizing:border-box" id="hqPerfVj" value="09/2023 – 08/2024"></div></div>';
  h += '<div><label style="display:block;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:4px">Notiz (optional)</label><textarea style="width:100%;border:1px solid #e5e7eb;border-radius:8px;padding:8px 12px;font-size:13px;box-sizing:border-box;resize:vertical" id="hqPerfNotiz" rows="2" placeholder="Wird den Partnern angezeigt…"></textarea></div>';
  h += '</div>';
