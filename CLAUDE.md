...
> Pipeline-Verkauf→verkauf_tracking Sync: Wenn Deal auf "Verkauft" gezogen wird, wird automatisch ein Eintrag in verkauf_tracking geschrieben (upsert: inkrementiert bestehende Eintraege). Monatsziel-Fortschrittsbalken in Wochenansicht (IST vs Plan aus jahresplaene, farbcodiert).
