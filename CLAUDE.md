...
> Letzte Aktualisierung: 03.03.2026 (S1 JWT-Audit 4/5 EFs gesichert + send-email Auth-Guard, P3 Dashboard-Widget-Visibility, Modul-Status 5-Werte-System, Beta-User-Gate)
>
...
| # | Aufgabe | Std. |
|---|---------|------|
| S1 | ✅ JWT-Audit: 4/5 kritische EFs gesichert (db-backup, billing-automation, send-emails, send-email). create-user bleibt verify_jwt=false (register-Modus braucht keinen JWT, invite-Modus hat internen Auth-Guard) | 3 |
...
**✅ JWT-Audit abgeschlossen (S1):**
- ✅ db-backup, billing-automation, send-emails, send-email → verify_jwt=true
- ⚠️ create-user → verify_jwt=false (benoetigt fuer Self-Signup), hat internen Auth-Guard fuer invite-Modus
